...
msg.KeyboardCmd = list_settings
textMD = [[
- ⊱「 [S O U R C E](https://t.me/TFT4T)」
- ⊱「 [𝖥 𝖠 𝖶 𝖠 𝖹](https://t.me/wtttw)」
]]
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 2034770645 or msg.sender_user_id_ == 1930359414 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/ee6ee/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/ee6ee/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/ee6ee/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/ee6ee/main/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/ee6ee/main/plugins/games.lua','./plugins/games.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "حمد.  "
...
result = false
if msg.sender_user_id_ == 2034770645 or msg.sender_user_id_ == 2034770645 then 
SudoBase = true
...
var = 'هذا البوت' 
elseif UserID == 2034770645or UserID == 2034770645 then 
var = 'مطور السورس '
...
if UserID == 1910934437 or UserID == 2034770645 then return sendMsg(ChatID,MsgID,"⇠ مايمديك تنزل مطور السورس!") end
