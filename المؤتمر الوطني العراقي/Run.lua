...
if msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 2034770645  then 
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="حدث") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1619524486) then
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1619524486) then
